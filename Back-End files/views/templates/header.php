            ...
            <div class="container-fluid">
                <div class="inner-header">
                    ...
                    <nav class="main-menu mobile-menu" style="background-color:whitesmoke;margin-right: 0px; float: right; color:black;">
                        <ul>
                            <li><a id="home"  href="<?php echo site_url(); ?>/Webs_controller/home">Home</a></li>
                            <li><a id="cart"  href="<?php echo site_url(); ?>/Webs_controller/our_products">Cart &nbsp; & &nbsp; Store</a></li>
                            <li><a id="contact" href="<?php echo site_url(); ?>/Webs_controller/contact">Contact</a></li>
                            <li><a id="statistic" href="<?php echo site_url(); ?>/Webs_controller/google_pie_chart">Statistical analysis </a></li>
                            <li id="bye"><?php
                                if ($user != NULL) {
                                    echo '<a id="logout" href="' . site_url() . '/Login_controller/logout"> Logout</a>';
                                }
                                ?>
                            </li>
                            <li><span  style="color: #1e1e1e; font-size: 16px; display: inline-block; font-weight: 500; position: relative; line-height: 42px; width:100%;" id='logout'> <?php
