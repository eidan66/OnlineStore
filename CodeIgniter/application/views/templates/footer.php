...
<!--        <footer> <img class="logo" src= "<?php echo base_url();?>assets/img/logo.png"/>
            &copy;  2020 Copyright:Mor Bitton, Idan Levian, Almog Davidof <br>
            Tel-Aviv Jafa Academic College 2019
        </footer>-->